'''Modifique a fun ̧c ̃ao “desempilha” para que ela retorne o elemento que foi desempilhado.'''
...
class pilha:
    ...
    def desempilha(self):
        ...
        if self.vazia():
            ...
            print('Elemento Desempilhado: ', self.topo.dado.valor)
            rem = self.topo
